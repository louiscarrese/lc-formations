...
@section('content')
    @foreach($inscriptions as $inscription)
        <div class="stagiaire">
            ...
            <div class="main">
                <p class="">
    Je, soussigné {{$responsableFormation}}, coordinateur des formations du Jardin Moderne, certifie que <strong>{{$inscription->stagiaire->prenom}} {{$inscription->stagiaire->nom}}</strong> a suivi avec assiduité la formation :
                </p>
