...
<form method="GET" action="{{$viewService->privateUrl('print/contrat/' . $inscription_id)}}" class="container" target="_blank">
    ...
    <p class="row">
        ...
        <input class="col-sm-6" type="text" name="adresse_stagiaire" value="{{$adresse_stagiaire}}" />
    </p>
    <p class="row">
    ...
    <p class="row">
        ...
        <input class="col-sm-5" type="text" name="dates" value="{{$dates}}" />
    </p>
    <p class="row">
        <label class="col-sm-3" for="montant">Montant à payer : </label>
        <input class="col-sm-2" type="text" name="montant" value="{{$montant}}" />
    </p>
