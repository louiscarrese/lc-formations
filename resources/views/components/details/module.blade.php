    ...
    <div class="detail-table-container">
        <table>
            <tr>
                <td class="key">Id</td>
                <td class="value">
                    <my-editable type="integer" ng-model="moduleCtrl.data.id" editing-flag="moduleCtrl.editing" size="1"></my-editable>
                </td>
            </tr>
            <tr>
                <td class="key">Libellé</td>
                <td class="value">
                    <my-editable type="text" ng-model="moduleCtrl.data.libelle" editing-flag="moduleCtrl.editing" size="40" class="full-width"></my-editable>
                </td>
            </tr>
            <tr>
                <td class="key">Nombre de jours</td>
                <td class="value">
                    <my-editable type="integer" ng-model="moduleCtrl.data.nb_jours" editing-flag="moduleCtrl.editing" size="1"></my-editable>
                </td>
            </tr>
            <tr>
                <td class="key">Heure de début</td>
                <td class="value">
                    <my-editable type="text" ng-model="moduleCtrl.data.heure_debut" editing-flag="moduleCtrl.editing" size="7"></my-editable>
                </td>
            </tr>
            <tr>
                <td class="key">Heure de fin</td>
                <td class="value">
                    <my-editable type="text" ng-model="moduleCtrl.data.heure_fin" editing-flag="moduleCtrl.editing" size="7"></my-editable>
                </td>
            </tr>
            <tr>
                <td class="key">Effectif maximum</td>
                <td class="value">
                    <my-editable type="integer" ng-model="moduleCtrl.data.effectif_max" editing-flag="moduleCtrl.editing" size="1"></my-editable>
                </td>
            </tr>
            <tr>
