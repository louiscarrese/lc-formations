...
function($scope, $element, $attrs, $compile, $log, $parse, $window, $document, $rootScope, $position, dateFilter, dateParser, datepickerPopupConfig, $timeout, datepickerConfig, $datepickerPopupLiteralWarning) {
  ...
  this.init = function(_ngModel_) {
    ...
    /** 
     * LCE add : Fix bug on second opening of the date picker
     *https://github.com/vitalets/angular-xeditable/issues/450
     */
...
angular.module('xeditable').directive('editableUiSelect',['editableDirectiveFactory',
    function(editableDirectiveFactory) {
        ...
        var dir = editableDirectiveFactory({
            ...
            render: function () {
                this.parent.render.call(this);
                this.inputEl.append(rename('ui-select-match', this.scope.match));
                this.inputEl.append(rename('ui-select-choices', this.scope.choices));
                this.inputEl.removeAttr('ng-model');
        ...
        dir.link = function (scope, el, attrs, ctrl) {
            ...
            scope.match = matchEl.clone();
            scope.choices = choicesEl.clone();
...
;
//# sourceMappingURL=preinscriptions-detail.js.map
