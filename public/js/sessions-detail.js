...
function sessionDetailServiceFactory(sharedDataService, modulesService, formateursService) {
    return {
...
angular.module('sessionsDetailServices', ['ngResource'])
    ...
    .factory('sessionDetailService', ['sharedDataService', 'modulesService', 'formateursService', sessionDetailServiceFactory])
...
angular.module('sessionsDetailApp', 
    ['sessionsDetailControllers', 'sessionsDetailServices', 'sessionsDetailFilters', 'sessionsDetailDirectives', 'ngMessages', 'ui.select', 'ngSanitize'])
;
